...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Tony liu"]
  spec.email = ["liuxiangping@ktjr.com"]

  spec.summary = %q{snowflake generate ID}
  spec.description = %q{The advantage of SnowFlake is that it is sorted by time increment on the whole, and there is no ID collision
